...
namespace Logica.Models
{
    public class Usuario
    {
        ...
        public bool Login()
        {
            ...
            //ahora agregamos todos los parámetros que solicita el SP de agregar
            MyCnn.ListaDeParametros.Add(new SqlParameter("@Cedula", this.Cedula)); 
            Tools.Crypto MiEncriptador = new Tools.Crypto();
            string ContrasenniaEncriptada = MiEncriptador.EncriptarEnUnSentido(this.Contrasennia);
            MyCnn.ListaDeParametros.Add(new SqlParameter("@Contrasennia", ContrasenniaEncriptada));  
            
            DataTable DatosUsuario = new DataTable();
            DatosUsuario = MyCnn.EjecutarSELECT("SPUsuariosLogin");
